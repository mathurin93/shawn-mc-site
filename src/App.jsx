      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-stone-900/95 backdrop-blur-md py-3 shadow-xl' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            {/* Logo Injection */}
            <div className="flex-shrink-0 cursor-pointer bg-white/95 p-1.5 rounded-full backdrop-blur-sm shadow-sm transition-transform hover:scale-105" onClick={() => scrollToSection('home')}>
              <img src={logoImg} alt="Master G Wallace Logo" className="h-12 md:h-16 w-auto rounded-full" />
            </div>
